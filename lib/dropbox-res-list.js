const resourcesDescriptionList = {
  ...
  'file_requests/list': {
    'uri': 'https://api.dropboxapi.com/2/file_requests/list',
    'requiresAuthHeader': true,
    'requiresReadableStream': false,
    'category': 'RPC',
    'parameters': {
  ...
  'deprecated/upload_session/append': {
...
module.exports = resourcesDescriptionList;
